...
fputcsv($out, ['ID','Nome','Login','Email','Celular','Telefone','CPF','RG','Nascimento','Tipo','CEP','Logradouro','Número','Bairro','Cidade','UF','Status','Cadastrado em'], ';');

foreach ($leads as $l) {
    fputcsv($out, [
        $l['id'], $l['nome'], $l['login'], $l['email'],
        $l['celular'], $l['telefone'], $l['cpf'], $l['rg'],
